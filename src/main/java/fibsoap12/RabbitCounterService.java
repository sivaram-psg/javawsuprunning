    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(fibsoap12.RabbitCounterService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = fibsoap12.RabbitCounterService.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:8888/fib?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8888/fib?wsdl', retrying as a local file");
